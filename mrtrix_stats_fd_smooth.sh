...
#SBATCH --job-name=fd
    ...
    singularity exec ${mx} fixelcfestats ${POP_DIR}/fd_smooth ${POP_DIR}/subj.txt ${POP_DIR}/Design_matrix_age_sex_educ_site_race_etiv.txt ${POP_DIR}/contrasts.txt ${POP_DIR}/tracks_2_million_sift_fixelconnmatrix ${POP_DIR}/fd_smooth_stats_age -nshuffles 500
