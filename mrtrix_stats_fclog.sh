...
#SBATCH --job-name=fd
    ...
    singularity exec ${mx} fixelcfestats ${POP_DIR}/log_fc ${POP_DIR}/subj.txt ${POP_DIR}/Design_matrix_age_sex_educ_site_race_etiv_vo2.txt ${POP_DIR}/contrasts_fitness.txt ${POP_DIR}/tracks_2_million_sift_fixelconnmatrix ${POP_DIR}/fclog_stats_vo2 -nshuffles 500
